...
<div class="bg-terciario flex overflow-x-hidden w-full shadow-md">
    ...
    <!--Usuario-->
    <div class="w-full justify-end flex mr-[20px] items-center">
        <a href="" class=" hidden md:block mr-[10px] underline text-blue-500">Cerrar sesion</a>
        <p class="text-fuente hidden md:block">Edgar Vega</p>
        
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 text-fuente ml-[10px] rounded-md px-1 my-1">
