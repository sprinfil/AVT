            ...
            <div class=" px-7 py-7 gap-x-20 grid grid-cols-1 md:grid-cols-2 text-fuente-secundaria">
                ...
                <div>
                    ...
                    <select wire:model="nacionalidad" name="nacionalidad" id="nacionalidad"
                        ...
                        <option value="Estadounidense" @if (old('nacionalidad') === 'Estadounidense') selected @endif>
                            Estadounidense</option>
                        <option value="Canadiense" @if (old('nacionalidad') === 'Canadiense') selected @endif>Canadiense
                        </option>
                    ...
                    <select wire:model="estado_civil" class="input-pdv w-full mb-3" name="estado_civil"
                        ...
                        <option value="DIVORCIAD@" @if (old('estado_civil') === 'DIVORCIAD@') selected @endif>DIVORCIAD@
                        </option>
                    </select>
                    @error('estado_civil')
                        <div class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center"> {{ $message }}
            ...
            <div class=" px-7 py-7 gap-x-20 grid grid-cols-1 md:grid-cols-2 text-fuente-secundario">
                ...
                <div>
                    ...
                    <select wire:model="municipio_direccion" name="municipio_direccion" id="municipio_direccion"
                        ...
                        @foreach ($municipiosDireccion as $municipio)
                            <option value="{{ $municipio->name }}"
                                @if (old('municipio_direccion') === '{{ $municipio->name }}') selected @endif> {{ $municipio->name }}</option>
                        @endforeach
                    ...
                    <select wire:model="pais_direccion" name="pais_direccion" id="pais_direccion"
                        ...
                        <option value="" selected>-- SELECCIONAR --</option>
                        <option value="Mexico" @if (old('pais') === 'Mexico') selected @endif>México</option>
                        <option value="Estados Unidos" @if (old('pais') === 'Estados Unidos') selected @endif>Estados
                            Unidos</option>
                        <option value="Canada" @if (old('pais') === 'Canada') selected @endif>Canada</option>
                        <option value="Otro" @if (old('pais') === 'Otro') selected @endif>Otro</option>
                    </select>
