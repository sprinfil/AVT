    ...
    <div class="mx-2 md:mx-[60px] mt-[20px] mb-[80px]">
        ...
        <div class="mt-[25px] grid md:grid-cols-4 grid-cols-1 gap-4">
            <a href="{{ route('personas') }}">
                <div
                    class="w-full h-[140px] duration-300 ease-in-out bg-principal  hover:bg-[#133B2F]  shadow-lg rounded-md overflow-x-hidden grid grid-rows-2 justify-center items-center cursor-pointer  px-4">
                    <div class="mt-5">
