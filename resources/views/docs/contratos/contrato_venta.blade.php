<style>
    @page {
        size: 8.5in 14in;
        /* Tamaño de página en pulgadas (oficio) */
    }
...
<div class="contenedor-principal">
    ...
    <div class="firma" style="margin-left: 220px;margin-top: 50px;">
        <div class="linea-negra"></div>
        <p class="negrita">EL VENDEDOR</p>
        <p>C. {{ $venta->Vendedor->nombreCompleto() }}.</p>
    </div>

    <table> <!-- Definición de la tabla con borde -->
        <thead>
            <tr>
                <th style="font-size: 15px;">    
                    <div class="firma" style="margin-top: 80px; display:inline-block;">
                    <div class="linea-negra"></div>
                ...
                <th style="font-size: 15px;">    
                    <div class="firma" style="margin-top: 80px; margin-left:200px; display:inline-block;">
                    <div class="linea-negra"></div>
